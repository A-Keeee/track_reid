...
def safe_download(url,
                  ...
                  min_bytes=1E0,
                  progress=True):
    from utils import TQDM,clean_url
    """
    ...
    Example:
        ...
        ```
    """
    from utils import emojis, is_online, url2file, LOGGER
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0', **kwargs):
    ...
    Example:
        ...
        ```
    """
    from utils import SETTINGS, checks, clean_url,url2file, LOGGER # scoped for circular import
